package com.ar.dev.ucubs.Fragments;
...
import com.ar.dev.ucubs.CartActivity;
import com.ar.dev.ucubs.CategoryProductsActivity;
import com.ar.dev.ucubs.HomeActivity;
import com.ar.dev.ucubs.Model.CartModel;
import com.ar.dev.ucubs.Model.ProductModel;
import com.ar.dev.ucubs.R;
import com.ar.dev.ucubs.UserLoginActivity;
...
public class HomeFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        addDataToRecyclerView("1st Year 1st Sem", rvFruits, fruitList);
        addDataToRecyclerView("1st Year 2nd Sem", rvVegetables, vegetableList);
        addDataToRecyclerView("2nd Year 1st Sem", rvElectronics, electronicsList);
        addDataToRecyclerView("2nd Year 2nd Sem", rvGrocery, groceryList);
        addDataToRecyclerView("3rd Year 1st Sem", rvPersonalCare, personalcareList);
        addDataToRecyclerView("3rd Year 2nd Sem", rvClothShoe, clothshoeList);
        addDataToRecyclerView("4th Year 1st Sem", rvJewellery, jewelleryList);
        addDataToRecyclerView("4th Year 2nd Sem", rvCosmetics, cosmeticsList);
    ...
    public void onClick(View v) {
        ...
        if (v == btnFruit) {
            intent.putExtra(HomeActivity.CATEGORY_NAME, "1st Year 1st Sem");
            startActivity(intent);

        } else if (v == btnVegetables) {
            intent.putExtra(HomeActivity.CATEGORY_NAME, "1st Year 2nd Sem");
            startActivity(intent);

        } else if (v == btnElectronics) {
            intent.putExtra(HomeActivity.CATEGORY_NAME, "2nd Year 1st Sem");
            startActivity(intent);

        } else if (v == btnGrocery) {
            intent.putExtra(HomeActivity.CATEGORY_NAME, "2nd Year 2nd Sem");
            startActivity(intent);

        } else if (v == btnPersonalCare) {
            intent.putExtra(HomeActivity.CATEGORY_NAME, "3rd Year 1st Sem");
            startActivity(intent);

        } else if (v == btnClothShoe) {
            intent.putExtra(HomeActivity.CATEGORY_NAME, "3rd Year 2nd Sem");
            startActivity(intent);

        } else if (v == btnJewellery) {
            intent.putExtra(HomeActivity.CATEGORY_NAME, "4th Year 1st Sem");
            startActivity(intent);

        } else if (v == btnCosmetics) {
            intent.putExtra(HomeActivity.CATEGORY_NAME, "4th Year 2nd Sem");
            startActivity(intent);
